...
<body>
    <div class="table-responsive">
        ...
        if ($count == 0) {
            echo "You havent add any item to sell!"; ?> <tr>
                    <td colspan="5">You havent add any item to sell! Please start <a href="addProduct.html">adding
                            products</a>right away!</td>
                </tr>
                <?php
        exit();
        }
